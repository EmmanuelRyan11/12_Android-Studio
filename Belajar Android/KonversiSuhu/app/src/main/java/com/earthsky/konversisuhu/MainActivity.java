package com.earthsky.konversisuhu;
...
//        String[] isi= {"Celcius to Reamur", "Celcius to Fahrenheir", "Celcius to Kelvin"};
...
//    }
    ...
    public void btnKonversi (View view){
        ...
        if (etNilai.getText().toString().equals("")){
            Toast.makeText(this, "Terdapat nilai yang kosong", Toast.LENGTH_SHORT).show();
        } else {
